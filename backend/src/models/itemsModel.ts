...
// Delete command function to delete rows/items from the items table
async function deleteItem (id: number): Promise<Item | null> {
    
    const queryText: string = 'DELETE FROM items WHERE id = $1';
